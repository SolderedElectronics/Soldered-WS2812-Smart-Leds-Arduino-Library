/**
 **************************************************
 * @file        ledPixelWithEasyC.ino
 * @brief       Simple examples of controlling the
 *              WS2812 LED pixel breakout with easyC
 *
 * @link        www.solde.red/SKU (nema ga u tablici)
...
long time1, time2, timeout = 6000; // Variables to change effects periodically
